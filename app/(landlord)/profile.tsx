...
import { User, Camera, ChevronRight, Bell, Lock, CircleHelp as HelpCircle, LogOut, Building } from 'lucide-react-native';
...
export default function LandlordProfileScreen() {
  ...
  const [companyName, setCompanyName] = useState('Imobiliária ABC');
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.contentContainer}>
        ...
        <Card variant="elevated" style={styles.settingsCard}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <Text style={styles.settingText}>Configurações da Empresa</Text>
            <ChevronRight size={20} color={COLORS.textLight} />
          </TouchableOpacity>
